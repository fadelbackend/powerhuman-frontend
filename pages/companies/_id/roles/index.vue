    ...
    <section class="pt-[50px]">
      ...
      <div class="mb-[30px]">
        ...
        >
          ...
          <nuxt-link :to="{name: 'companies-id-roles-create'}" class="btn btn-primary">New Role</nuxt-link>
        </div>
      </div>

      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-[30px]">
      <p v-if="$fetchState.pending">Fetching roles...</p>
        <div class="items-center card !flex-row gap-4" v-else v-for="roles in roles.data.data.data">
          <a
            href="#"
